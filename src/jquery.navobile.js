...
(function() {
  ...
  (function($) {
    $.navobile = function(el, method) {
      ...
      base.bindClick = function($cta, $nav, $content) {
        return $cta.click(function(e) {
          if ($nav.data('open')) {
      ...
      base.removeInlineStyles = function($nav, $content) {
        ...
        return $nav.css('opacity', '');
      };
      base.draggedNavOpacity = function(translateX) {
        if (translateX > 40) {
          return 1;
        } else {
          return parseFloat(translateX / 40);
        }
      };
      methods = {
